...
async def get_book(book_uuid: str, session: AsyncSession = Depends(get_session)) -> dict:
...
async def update_book(book_uuid: str, book_data: BookUpdateModel, session: AsyncSession = Depends(get_session)):
...
async def delete_a_book(book_uuid: str, session: AsyncSession = Depends(get_session)):
